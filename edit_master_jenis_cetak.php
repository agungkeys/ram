...
$id = $_GET['us'];
$rs=$koneksi->Execute("select * from jenis_cetak where id_jenis_cetak = '$id'");
if ($rs->RecordCount() > 0){			
	while(!$rs->EOF){
		$id 	= $rs->fields[0];
		$jc 	= $rs->fields[1];
                        	...
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        Edit Manajemen Jenis Cetak
                                    </span>
                                </div>
                                <div class="da-panel-content">
                                	<form id="da-ex-validate5" class="da-form" method="post" action="proses_edit_master_jenis_cetak.php">
                                    	<div id="da-ex-val5-error" class="da-message error" style="display:none;"></div>
                                        <div class="da-form-inline">
                                            <div class="da-form-row">
                                                <label>ID Jenis Cetak<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                    <input type="text" readonly="readonly" name="txtidjeniscetak" value="<?php echo"$id"; ?>" />
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Jenis Cetak<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                    <input type="text" name="txtjeniscetak" value="<?php echo"$jc"; ?>" />
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Keterangan<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                    <input type="text" name="txtketerangan" value="<?php echo"$ket"; ?>" />
                                                </div>
                                            </div>
                                        </div>
                        	...
                        	<div class="da-panel">
                                ...
                                <div class="da-panel-content">
                                    <table id="da-ex-datatable-default" class="da-table">
                                        ...
                                        <tbody>
                                        <?php
										$tampildat=mysql_query("SELECT * FROM jenis_cetak ORDER BY id_jenis_cetak ASC");
										while($tampildata=mysql_fetch_array($tampildat)){
										?>
                                            <tr>
                                                <td><?=$tampildata['id_jenis_cetak']?></td>
                                                <td><?=$tampildata['jenis_cetak']?></td>
                                                <td><?=$tampildata['keterangan']?></td>
                                                <td class="da-icon-column">
                                                	<a href="edit_master_jenis_cetak.php?us=<?=$tampildata['id_jenis_cetak']?>"><img src="images/icons/color/pencil.png" /></a>
                                                    <a href="delete_master_jenis_cetak.php?us=<?=$tampildata['id_jenis_cetak']?>"><img src="images/icons/color/cross.png" /></a>
                                                </td>
