...
<tbody>
	...
	?>
		...
		<tr>
			...
			<td><a class="da-button orange" href="upload_kerjakan_design.php?us=<?php $id=$sql['id_detail_transaksi'];echo"$id"; ?>">Upload</a></td>
		</tr>
	<?php
	}
