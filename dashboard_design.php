...
</script>Anda bukan design <button onclick='goBack()'>Kembali</button>");
}
...
<title>Dashboard Design || Reklamindo Aplication Manager</title>
                        	...
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        ...
                                        Realtime Data Design || Perintah Kerja
                                    </span>
                                ...
                                <div class="da-panel-content">
                                        	...
                                        	<div id="tableID">
                                            	<?php include_once'realtime_design.php'; ?>
                                            </div>
                                       		<script type='text/javascript'>
												  var table = $('#tableID');
												 // refresh every 5 seconds
												 var refresher = setInterval(function(){
												   table.load("realtime_design.php");
												 }, 3000);
												 setTimeout(function() {
                        ...
                        <div class="grid_4">
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        <img src="images/icons/black/16/list.png" alt="" />
                                        Realtime Data Design || File On Proggress
                                    </span>
                                ...
                                <div class="da-panel-content">
                                        	...
                                        	<div id="tableIDkerja">
                                            	<?php include_once'realtime_design1.php'; ?>
                                            </div>
                                       		<script type='text/javascript'>
												  var tablekerja = $('#tableIDkerja');
												 // refresh every 5 seconds
												 var refresherkerja = setInterval(function(){
												   tablekerja.load("realtime_design1.php");
												 }, 3000);
												 setTimeout(function() {
												   clearInterval(refresherkerja);
												 }, 1800000);
											</script>
                        ...
                        <div class="grid_4">
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        <img src="images/icons/black/16/list.png" alt="" />
                                        Realtime Data Design || Finish File
                                    </span>
                                    
                                </div>
                                <div class="da-panel-content">
                                    
                                        	<div id="tableIDkerjaselesai">
                                            	<?php include_once'realtime_design2.php'; ?>
                                            </div>
                                       		<script type='text/javascript'>
												  var tablekerjaselesai = $('#tableIDkerjaselesai');
												 // refresh every 5 seconds
												 var refresherkerjaselesai = setInterval(function(){
												   tablekerjaselesai.load("realtime_design2.php");
												 }, 3000);
												 setTimeout(function() {
												   clearInterval(refresherkerjaselesai);
												 }, 1800000);
											</script>
