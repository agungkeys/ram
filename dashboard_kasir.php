...
<title>Dashboard Kasir || Reklamindo Aplication Manager</title>
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                	...
                	<div id="da-content-area">
                    	<div class="grid_3">
                            <h1>Selamat Datang Kasir <?php echo"$name";?></h1>
                                	...
                                	<li>
                                    	<a href="#">
                                            ...
                                            <span class="da-summary-text">
                                                <span class="value down">5</span>
                                                <span class="label">Design Proses</span>
                                            </span>
                                        </a>
                                    </li>
                                    <li>
                                    	<a href="#">
                                            ...
                                            <span class="da-summary-text">
                                                <span class="value up">3</span>
                                                <span class="label">Design Selesai</span>
                                            </span>
                                        </a>
                                    </li>
                                    <li>
                                    	<a href="#">
                                            <span class="da-summary-icon" style="background-color:#e15656;">
                                                <img src="images/icons/white/32/box_outgoing.png" alt="" />
                                            </span>
                                            <span class="da-summary-text">
                                                <span class="value down">5</span>
                                                <span class="label">Printing Proses</span>
                                            </span>
                                        </a>
                                    </li>
                                    <li>
                                    	<a href="#">
                                            ...
                                            <span class="da-summary-text">
                                                <span class="value up">3</span>
                                                <span class="label">Printing Selesai</span>
                                            </span>
                                        </a>
                                    </li>
