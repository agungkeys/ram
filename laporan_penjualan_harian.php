...
<title>Laporan Penjualan Harian || Reklamindo Aplication Manager</title>
                        	...
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
										...
										?>
                                        Laporan Penjualan Harian per/Tanggal: <b><?php echo"$newDate1";?></b>
                                    </span>
                                ...
                                <div class="da-panel-content">
                                    <table id="da-ex-datatable-numberpaging" class="da-table">
										...
										<?php
										$tampildat="SELECT id_transaksi, nama_customer, telp, nama_kasir, ppn, bayar, total, tanggal,  pelunasan, tanggal_pelunasan FROM transaksi WHERE tanggal='$tagl1' or tanggal_pelunasan='$tagl1'";
										...
										?>
                                            ...
                                            <tr>
												...
												<td><?php echo $sql['tanggal_pelunasan']; ?></td>
												<td><?php echo "Rp ".number_format($sql['pelunasan'], $jumlah_desimal, $pemisah_desimal, $pemisan_ribuan); 
												$pelunasan=$sql['pelunasan'];
                                        ...
                                        <tfoot>
											...
											<tr>
                                                ...
                                                <td><b>
                                                <?php
												$totalpelunasanfix=array_sum($totalpelunasan);
												echo"Rp ".number_format($totalpelunasanfix, $jumlah_desimal, $pemisah_desimal, $pemisan_ribuan);;
												?>
                                                </b></td>
											...
											<tr bgcolor="#FFCCFF">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="2">Total Pemasukan <b><?php echo"$newDate1";?></b></td>
												<td colspan="3" style="text-align:center; font-size:14px;"><b>
												<?php
												$totalpemasukannyafix=$totalpemasukanfix + $totalpelunasanfix;
												echo"Rp ".number_format($totalpemasukannyafix, $jumlah_desimal, $pemisah_desimal, $pemisan_ribuan);;
												?>
												</b></td>
											</tr>
                                        </tfoot>
