...
$id = $_GET['us'];
$rs=$koneksi->Execute("select * from jenis_bahan where id_jenis_bahan = '$id'");
if ($rs->RecordCount() > 0){			
	while(!$rs->EOF){
		$id 	= $rs->fields[0];
		$jb 	= $rs->fields[1];
                        	...
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        Edit Manajemen Jenis Bahan
                                    </span>
                                </div>
                                <div class="da-panel-content">
                                	<form id="da-ex-validate6" class="da-form" method="post" action="proses_edit_master_jenis_bahan.php">
                                        ...
                                        <div class="da-form-inline">
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                    <input type="text" readonly="readonly" name="txtidjenisbahan" value="<?php echo"$id"; ?>" />
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Nama Bahan<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                    <input type="text" name="txtjenisbahan" value="<?php echo"$jb"; ?>" />
                                                </div>
                                            </div>
                                            <div class="da-form-row">
