...
$query = "SELECT max(id_jenis_cetak) AS last FROM jenis_cetak";
                        	...
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        Manajemen Jenis Cetak
                                    </span>
                                </div>
                                <div class="da-panel-content">
                                	<form id="da-ex-validate5" class="da-form" method="post" action="proses_master_jenis_cetak.php">
                                        ...
                                        <div class="da-form-inline">
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                    <input type="text" readonly="readonly" name="txtidjeniscetak" value="<?php echo"$lastNoUrut"; ?>" />
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Jenis Cetak<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                    <input type="text" name="txtjeniscetak" />
                                                </div>
                                            </div>
                                            <div class="da-form-row">
